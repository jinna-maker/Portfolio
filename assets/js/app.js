...
function renderProjects(projects) {
  ...
  grid.innerHTML = projects.map(project => {
    ...
    return `
      <article class="card">
        <img class="card-image" src="${escapeAttr(image)}" alt="${escapeAttr(title)}" loading="lazy">
        <div class="card-body">
...
function renderMedia(items) {
  ...
  target.innerHTML = items.map(item => {
    ...
    return `
      <article class="card">
        <img class="card-image" src="${escapeAttr(thumb)}" alt="${escapeAttr(title)}" loading="lazy">
        <div class="card-body">
